...
int main(){
    ...
    for(int i=1;i<3;i++){
        printf("Enter the the name of player %d:",i);
        scanf("%s",&listofusers[i-1].name);
        printf("\n");
        printf("Enter the colour to play:");
        scanf("%s",&listofusers[i-1].colour);
    ...
    while(noofrounds>=round){
        ...
        printf("2)DO u want to move round \n");
        printf("Ebter you choice:");
        scanf("%d",&ch);
        /*result goes to scoreboad*/
        if(ch==1)
        {
